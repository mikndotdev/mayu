      ...
      <header className="relative w-full z-40">
        <div className="bg-(--light-blue-color)">
          <div className="w-11/12 md:w-2/3 mx-auto py-4 flex flex-col items-center">
            {topTitle && (
              <h1 className="text-white text-lg font-bold mb-3 text-center">{topTitle}</h1>
            )}
            <img src={image} alt="Logo" className="h-16 md:h-20 object-contain" />
          </div>
        </div>
                ...
                <ul className="grid grid-cols-2 md:flex gap-4 md:gap-8 list-none m-0 p-0">
                  {menu.map((item, index) => (
                    <li
                      ...
                      onMouseEnter={() =>
                        !isMobile && item.links && item.links.length > 0 && setOpenDropdown(index)
                      }
                          ...
                          <button
                            onClick={() =>
                              isMobile
                                ...
                                : (window.location.href = item.topLink.url)
                            }
          ...
          >
            <div className="w-11/12 md:w-2/3 mx-auto">
              <nav className="flex items-center justify-between py-3">
                <img src={image} alt="Logo" className="h-12 object-contain" />
                  ...
                  <ul className="flex gap-8 list-none m-0 p-0">
                    {menu.map((item, index) => (
                      <li
                        ...
                        className="relative"
                        onMouseEnter={() =>
                          item.links && item.links.length > 0 && setOpenDropdown(index)
                        }
